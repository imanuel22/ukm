<h1>form edit ukm</h1>
<form action="<?= base_url('cketua/insert_data_ukm')?>" method="post">
		<div class="mb-3">
		...
		<div class="mb-3">
			...
			<input type="file" name="img_ukm" class="form-control" id="img_ukm">
		</div>
		<div class="mb-3">
			<label for="tgl_buat" class="form-label">tgl_buat</label>
			<input type="text" name="tgl_buat" class="form-control" id="tgl_buat">
		</div>	
