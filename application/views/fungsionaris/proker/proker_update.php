<div class="bg-info rounded-3 text-light p-3">
    ...
    <div class="mb-3">
			...
			<input type="text" name="nama_proker" id="nama_proker" class="form-control" value="<?=$data_proker_id->nama_proker?>">
	</div>	
	<div class="mb-3">
			<label for="deskripsi" class="form-label">deskripsi</label>
			<input type="text" name="deskripsi" id="deskripsi" class="form-control"  value="<?=$data_proker_id->deskripsi?>">
	</div>	
	<div class="mb-3">
			<label for="peraturan" class="form-label">peraturan</label>
			<input type="text" name="peraturan" id="peraturan" class="form-control"  value="<?=$data_proker_id->peraturan?>">
	</div>	
    <div class="mb-3 row">
        <div class="col-6">
