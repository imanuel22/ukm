    ...
    <div class="l-navbar" id="nav-bar">
      <nav class="nav">
        <div> 
          ...
          <div class="nav_list"> 
            <a href="<?= base_url('cbem/dashboard'); ?>" class="nav_link <?=$tombol?>"> 
              <i class='bx bx-grid-alt nav_icon'></i> 
              <span class="nav_name">Home</span> 
            </a> 
            <a href="<?= base_url('cbem/mahasiswa'); ?>" class="nav_link <?=$tombol?>"> 
              <i class='bx bx-home nav_icon'></i>
              <span class="nav_name">CRUD MAHASISWA</span> 
            </a> 
            <a href="<?= base_url('cbem/ukm'); ?>" class="nav_link <?=$tombol?>"> 
