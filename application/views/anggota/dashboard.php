...
<body className='snippet-body'>
	...
	<body id="body-pd">
		...
		<div class="l-navbar" id="nav-bar">
			<nav class="nav">
				<div>
					<a href="<?= base_url('canggota/dashboard'); ?>" class="nav_logo">
						<i class="fa-solid fa-image"></i>
						<span class="nav_logo-name">UKM</span>
					</a>
					<div class="nav_list">
						<a href="<?= base_url('canggota/dashboard'); ?>" class="nav_link ">
							<i class="fa-solid fa-house"></i>
							<span class="nav_name">Home</span>
						</a>
						<a href="<?= base_url('canggota/daftar_fungsio'); ?>" class="nav_link ">
							<i class="fa-solid fa-database"></i>
							<span class="nav_name">Daftar Fungsionaris</span>
						</a>
						<a href="<?= base_url('canggota/jurusan'); ?>" class="nav_link">
							<i class="fa-solid fa-database"></i>
							<span class="nav_name">CRUD Jurusan</span>
						</a>
						<a href="<?= base_url('canggota/prodi'); ?>" class="nav_link">
