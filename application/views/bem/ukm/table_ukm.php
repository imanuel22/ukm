		...
		?>
						<tr>
							...
							<td class="text-center">
								<img src="<?=base_url('assets/uploads/ukm/').$row->img_ukm?>" alt="" width="150"
									height="150">
							</td>
							<td><?=$row->nama_ukm?></td>
							...
							<td class="text-center">
								<button type="button" class="btn btn-warning" onclick="editdata(<?=$row->id_ukm?>)"><i
										class="ti ti-pencil"></i></button>
								<button type="button" class="btn btn-danger" onclick="hapus(<?=$row->id_ukm?>)"><i
